...
typedef struct __mavlink_wheel_encoders_t {
 uint64_t time_us; /*< [us] */
 int32_t left_ticks; /*< [ticks] */
 int32_t right_ticks; /*< [ticks] */
 uint16_t cam_pos; /*< [raw12] */
} mavlink_wheel_encoders_t;

#define MAVLINK_MSG_ID_WHEEL_ENCODERS_LEN 18
#define MAVLINK_MSG_ID_WHEEL_ENCODERS_MIN_LEN 18
#define MAVLINK_MSG_ID_42003_LEN 18
#define MAVLINK_MSG_ID_42003_MIN_LEN 18

#define MAVLINK_MSG_ID_WHEEL_ENCODERS_CRC 98
#define MAVLINK_MSG_ID_42003_CRC 98
...
#define MAVLINK_MESSAGE_INFO_WHEEL_ENCODERS { \
    ...
    "WHEEL_ENCODERS", \
    4, \
    {  { "time_us", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_wheel_encoders_t, time_us) }, \
         { "left_ticks", NULL, MAVLINK_TYPE_INT32_T, 0, 8, offsetof(mavlink_wheel_encoders_t, left_ticks) }, \
         { "right_ticks", NULL, MAVLINK_TYPE_INT32_T, 0, 12, offsetof(mavlink_wheel_encoders_t, right_ticks) }, \
         { "cam_pos", NULL, MAVLINK_TYPE_UINT16_T, 0, 16, offsetof(mavlink_wheel_encoders_t, cam_pos) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_WHEEL_ENCODERS { \
 ...
 *
 * @param time_us [us] 
 * @param left_ticks [ticks] 
 * @param right_ticks [ticks] 
 * @param cam_pos [raw12] 
...
static inline uint16_t mavlink_msg_wheel_encoders_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t time_us, int32_t left_ticks, int32_t right_ticks, uint16_t cam_pos)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_WHEEL_ENCODERS_LEN];
    _mav_put_uint64_t(buf, 0, time_us);
    _mav_put_int32_t(buf, 8, left_ticks);
    _mav_put_int32_t(buf, 12, right_ticks);
    _mav_put_uint16_t(buf, 16, cam_pos);
...
static inline void mavlink_msg_wheel_encoders_send(mavlink_channel_t chan, uint64_t time_us, int32_t left_ticks, int32_t right_ticks, uint16_t cam_pos)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_WHEEL_ENCODERS_LEN];
    _mav_put_uint64_t(buf, 0, time_us);
 ...
 */
static inline void mavlink_msg_wheel_encoders_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_us, int32_t left_ticks, int32_t right_ticks, uint16_t cam_pos)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return [us] 
 */
static inline uint64_t mavlink_msg_wheel_encoders_get_time_us(const mavlink_message_t* msg)
{
