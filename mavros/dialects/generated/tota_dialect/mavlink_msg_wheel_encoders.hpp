 ...
 *
 * Cumulative wheel ticks (CW = +, CCW = –) and the absolute 12-bit
      AS5600 CAM position used by the jumping mechanism.
 */
struct WHEEL_ENCODERS : mavlink::Message {
    ...
    inline void serialize(mavlink::MsgMap &map) const override
    {
        ...
        map << left_ticks;                    // offset: 8
        map << right_ticks;                   // offset: 12
        map << cam_pos;                       // offset: 16
    }
