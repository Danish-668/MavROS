...
#define MAVLINK_MSG_ID_PING_LEN 10
#define MAVLINK_MSG_ID_PING_MIN_LEN 10
#define MAVLINK_MSG_ID_4_LEN 10
#define MAVLINK_MSG_ID_4_MIN_LEN 10

#define MAVLINK_MSG_ID_PING_CRC 40
#define MAVLINK_MSG_ID_4_CRC 40
...
#define MAVLINK_MESSAGE_INFO_PING { \
    ...
    "PING", \
    4, \
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_ping_t, time_usec) }, \
         { "seq", NULL, MAVLINK_TYPE_UINT32_T, 0, 4, offsetof(mavlink_ping_t, seq) }, \
         { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 8, offsetof(mavlink_ping_t, target_system) }, \
         { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 9, offsetof(mavlink_ping_t, target_component) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PING { \
...
static inline uint16_t mavlink_msg_ping_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint32_t time_usec, uint32_t seq, uint8_t target_system, uint8_t target_component)
{
...
static inline void mavlink_msg_ping_send(mavlink_channel_t chan, uint32_t time_usec, uint32_t seq, uint8_t target_system, uint8_t target_component)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PING_LEN];
    _mav_put_uint32_t(buf, 0, time_usec);
 ...
 */
static inline void mavlink_msg_ping_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_usec, uint32_t seq, uint8_t target_system, uint8_t target_component)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint32_t mavlink_msg_ping_get_time_usec(const mavlink_message_t* msg)
{
