...
typedef struct __mavlink_tof_l7cx_ranges_t {
 ...
 uint16_t range_mm[64]; /*< [mm] 8x8 zone distances array*/
} mavlink_tof_l7cx_ranges_t;

#define MAVLINK_MSG_ID_TOF_L7CX_RANGES_LEN 132
#define MAVLINK_MSG_ID_TOF_L7CX_RANGES_MIN_LEN 132
#define MAVLINK_MSG_ID_42001_LEN 132
#define MAVLINK_MSG_ID_42001_MIN_LEN 132

#define MAVLINK_MSG_ID_TOF_L7CX_RANGES_CRC 173
#define MAVLINK_MSG_ID_42001_CRC 173
...
#define MAVLINK_MESSAGE_INFO_TOF_L7CX_RANGES { \
    ...
    "TOF_L7CX_RANGES", \
    2, \
    {  { "time_us", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_tof_l7cx_ranges_t, time_us) }, \
         { "range_mm", NULL, MAVLINK_TYPE_UINT16_T, 64, 4, offsetof(mavlink_tof_l7cx_ranges_t, range_mm) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_TOF_L7CX_RANGES { \
 ...
 * @param range_mm [mm] 8x8 zone distances array
...
static inline void mavlink_msg_tof_l7cx_ranges_send(mavlink_channel_t chan, uint32_t time_us, const uint16_t *range_mm)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_TOF_L7CX_RANGES_LEN];
    _mav_put_uint32_t(buf, 0, time_us);
 ...
 */
static inline void mavlink_msg_tof_l7cx_ranges_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_us, const uint16_t *range_mm)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint32_t mavlink_msg_tof_l7cx_ranges_get_time_us(const mavlink_message_t* msg)
{
